...
function findLastIndexOf(mainStr, subStr) {
    ...
    return mainStr.findLastIndexOf(subStr);
}
...
function compareCharCodeAtAndCodePointAt(string, index) {
    ...
    // Використовуємо метод , щоб отримати код символа з рядка на певній позиції, та запишемо результат в змінну charCodeAtResult
